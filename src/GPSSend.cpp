...
#if defined(RTK_SEND)
  // printf("rssi %d temp %4.1f data %d connected %d millis %u connectTmr %u\n",
  //  static_cast<int>(rssi), temp, rtk.rxCount, connected,
  //  static_cast<unsigned int>(millis()), connectTmr);
